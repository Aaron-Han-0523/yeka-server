...
print("")
print("==============example==============")
print("$ python3 autoGenController.py auto_controller.js")
print("")
print("input : table/Product")
print("input : table/Community")
print("input : table/Order")
print("")
print("output : controllers/product.js")
print("output : controllers/community.js")
print("output : controllers/order.js")
print("===================================")
print("")
...
for res_file in file_list:
    ...
    output_path = "controllers/" + res_snake + ".js"
